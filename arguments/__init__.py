...
class SplattingSettings():
    ...
    def __init__(self, parser, render=False):
        ...
        self.group_settings.add_argument("--rect_bounding", type=bool, choices=[True, False], help="Bound 2D Gaussians with a rectangle instead of a circle")
        self.group_settings.add_argument("--tight_opacity_bounding", type=bool, choices=[True, False], help="Bound 2D Gaussians by considering their opacity")
        self.group_settings.add_argument("--tile_based_culling", type=bool, choices=[True, False], help="Cull complete tiles based on opacity")
        self.group_settings.add_argument("--hierarchical_4x4_culling", type=bool, choices=[True, False], help="Cull Gaussians for 4x4 subtiles, only when using sort_mode HIER")
        self.group_settings.add_argument("--load_balancing", type=bool, choices=[True, False], help="Perform per-tile computations cooperatively (e.g. duplication)")
        self.group_settings.add_argument("--proper_ewa_scaling", type=bool, choices=[True, False], help='Dilation of 2D Gaussians as proposed by Yu et al. ("Mip-Splatting")')
